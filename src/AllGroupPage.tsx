    ...
    <div className="min-h-screen bg-gray-100 p-8 text-gray-800 font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {groups.map((group: any) => (
          <div
            key={group.id}
            className="bg-[#34699A] text-white p-6 rounded-xl shadow-lg cursor-pointer transition-transform hover:scale-105"
          ...
          >
            ...
            <div className="flex justify-end">
              <button
                ...
                className="text-white bg-[#113F67] hover:bg-gray-600 px-4 py-2 rounded-lg transition-colors"
              >
                View
              </button>
            </div>
